...
import { getSingleProduct } from '../Fetures/GetDataSlice'
        ...
        <div className='single-main'>
            {
                isSingleLoading ? <h2>Loading.......</h2> :
                    singleProduct && <div className="single-wrapper">
                        <div className="single-image">
                            <img src={singleProduct.image} alt={singleProduct.name} />
                            <div className="cart-btn">
                                <button onClick={() => {
                                    dispatch(addToCart({ id: singleProduct.id, name: singleProduct.name, price: singleProduct.price, image: singleProduct.image, quantity: 1 }));
